function assess() {
	var attribInputs = document.getElementsByClassName("attribInput");
	console.log(attribInputs.length);
	for (let X = 0; X < attribInputs.length; X++) {
		console.log(X);
		attribInputs[X].setAttribute("disabled", "");
	}

	var Inputs0 = document.getElementsByClassName("Inputs0");
	for (let X = 0; X < Inputs0.length; X++) {
		console.log(X);
		Inputs0[X].setAttribute("disabled", "");
	}
	
	if (document.getElementById("button0").innerHTML == "Assess") {
		document.getElementById("button0").innerHTML = "Edit";
		...
		document.getElementById("button0").innerHTML = "Assess";
		document.getElementById("OCC").style.display = "none";
		for (let X = 0; X < Inputs0.length; X++) {
			Inputs0[X].removeAttribute("disabled");
		}
		for (let X = 0; X < attribInputs.length; X++) {
			attribInputs[X].removeAttribute("disabled");
		}
	}
