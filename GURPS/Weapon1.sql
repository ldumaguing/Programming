delete from Stuffs where Id >= 10000;
...
delete from Stuffs where Id >= 10042;
delete from Stuffs where ClassType = 'Weapon' and Id >= 10042;
...
-- select Id, Name, json_detailed(Definition) from Stuffs;
