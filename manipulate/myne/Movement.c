...
void stepBack ( char *objName ) {
    ...
    if ( strstr ( json_object_get_string ( Facing ), "A" ) > 0 ) moveHex ( location, 3 );
    else if ( strstr ( json_object_get_string ( Facing ), "B" ) > 0 ) moveHex ( location, 4 );
    else if ( strstr ( json_object_get_string ( Facing ), "C" ) > 0 ) moveHex ( location, 5 );
    else if ( strstr ( json_object_get_string ( Facing ), "D" ) > 0 ) moveHex ( location, 0 );
    else if ( strstr ( json_object_get_string ( Facing ), "E" ) > 0 ) moveHex ( location, 1 );
    else moveHex ( location, 2 );
