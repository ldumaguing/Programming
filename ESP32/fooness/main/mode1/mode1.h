...
uint8_t background[MAP_HEIGHT * MAP_WIDTH];
uint8_t bg_palette[MAP_HEIGHT * MAP_WIDTH];
uint8_t height_offset;  // (maybe?) in map blocks (8 pixels)
uint16_t global_background;
uint16_t *palette[8];
