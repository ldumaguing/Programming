// *************** Fri Aug 25 04:37:44 PM EDT 2023
// *************************************************************************************************
...
#define controlPins 0xF0
#define datumPins   0x7F08

#define ILI9341_WIDTH 240  ///< ILI9341 max TFT width
#define ILI9341_HEIGHT 320 ///< ILI9341 max TFT height
#define ILI9341_SIZE (ILI9341_HEIGHT * ILI9341_WIDTH)
...
#define ACHTUNG1_ON   *gpio_out_w1ts_reg = (1 << LED_L)
#define ACHTUNG1_OFF  *gpio_out_w1tc_reg = (1 << LED_L)
#define ACHTUNG2_ON   *gpio_out1_w1ts_reg = (1 << LED_R)
#define ACHTUNG2_OFF  *gpio_out1_w1tc_reg = (1 << LED_R)
...
static inline void init_pins() {
	*gpio_enable_reg = datumPins | controlPins | (1 << LED_L);
