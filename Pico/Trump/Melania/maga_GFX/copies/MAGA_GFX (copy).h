...
#include <MAGA_I2CDevice.h>
#include <MAGA_SPIDevice.h>

/// A generic graphics superclass that can handle all sorts of drawing. At a
/// minimum you can subclass and provide drawPixel(). At a maximum you can do a
/// ton of overriding to optimize. Used for any/all Adafruit displays!
class MAGA_GFX : public Print {

public:
  MAGA_GFX(int16_t w, int16_t h); // Constructor
  ...
  */
  ...
  // These exist only with MAGA_GFX (no subclass overrides)
...
class MAGA_GFX_Button {

public:
  MAGA_GFX_Button(void);
  // "Classic" initButton() uses center & size
  void initButton(MAGA_GFX *gfx, int16_t x, int16_t y, uint16_t w,
  ...
  void initButtonUL(MAGA_GFX *gfx, int16_t x1, int16_t y1, uint16_t w,
                    uint16_t h, uint16_t outline, uint16_t fill,
                    uint16_t textcolor, char *label, uint8_t textsize);
  void initButtonUL(MAGA_GFX *gfx, int16_t x1, int16_t y1, uint16_t w,
                    uint16_t h, uint16_t outline, uint16_t fill,
...
class GFXcanvas1 : public MAGA_GFX {
public:
...
class GFXcanvas16 : public MAGA_GFX {
public:
