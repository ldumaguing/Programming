...
*/
/**************************************************************************/
void MAGA_GFX::writePixel(int16_t x, int16_t y, uint16_t color) {
  drawPixel(x, y, color);
}
...
*/
/**************************************************************************/
void MAGA_GFX::writeFillRect(int16_t x, int16_t y, int16_t w, int16_t h,
                                 uint16_t color) {
...
*/
/**************************************************************************/
void MAGA_GFX::drawLine(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                            uint16_t color) {
...
*/
/**************************************************************************/
void MAGA_GFX::drawCircleHelper(int16_t x0, int16_t y0, int16_t r,
...
*/
/**************************************************************************/
void MAGA_GFX::fillCircle(int16_t x0, int16_t y0, int16_t r,
                              uint16_t color) {
  startWrite();
...
*/
/**************************************************************************/
void MAGA_GFX::fillCircleHelper(int16_t x0, int16_t y0, int16_t r,
...
*/
/**************************************************************************/
void MAGA_GFX::drawRoundRect(int16_t x, int16_t y, int16_t w, int16_t h,
...
*/
/**************************************************************************/
void MAGA_GFX::fillRoundRect(int16_t x, int16_t y, int16_t w, int16_t h,
                                 int16_t r, uint16_t color) {
  int16_t max_radius = ((w < h) ? w : h) / 2; // 1/2 minor axis
  if (r > max_radius)
    r = max_radius;
...
*/
/**************************************************************************/
void MAGA_GFX::drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
...
*/
/**************************************************************************/
void MAGA_GFX::fillTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1,
                                int16_t x2, int16_t y2, uint16_t color) {
...
*/
/**************************************************************************/
void MAGA_GFX::drawBitmap(int16_t x, int16_t y, const uint8_t bitmap[],
...
*/
/**************************************************************************/
void MAGA_GFX::drawBitmap(int16_t x, int16_t y, uint8_t *bitmap, int16_t w,
...
*/
/**************************************************************************/
void MAGA_GFX::drawXBitmap(int16_t x, int16_t y, const uint8_t bitmap[],
                               int16_t w, int16_t h, uint16_t color) {
...
*/
/**************************************************************************/
void MAGA_GFX::drawGrayscaleBitmap(int16_t x, int16_t y,
...
*/
/**************************************************************************/
void MAGA_GFX::drawGrayscaleBitmap(int16_t x, int16_t y, uint8_t *bitmap,
                                       int16_t w, int16_t h) {
  startWrite();
  for (int16_t j = 0; j < h; j++, y++) {
    for (int16_t i = 0; i < w; i++) {
...
*/
/**************************************************************************/
void MAGA_GFX::drawRGBBitmap(int16_t x, int16_t y, const uint16_t bitmap[],
                                 int16_t w, int16_t h) {
  startWrite();
  for (int16_t j = 0; j < h; j++, y++) {
    for (int16_t i = 0; i < w; i++) {
...
*/
/**************************************************************************/
void MAGA_GFX::drawRGBBitmap(int16_t x, int16_t y, uint16_t *bitmap,
                                 int16_t w, int16_t h) {
  startWrite();
  for (int16_t j = 0; j < h; j++, y++) {
    for (int16_t i = 0; i < w; i++) {
...
*/
/**************************************************************************/
void MAGA_GFX::drawChar(int16_t x, int16_t y, unsigned char c,
...
*/
/**************************************************************************/
size_t MAGA_GFX::write(uint8_t c) {
  if (!gfxFont) { // 'Classic' built-in font
...
*/
/**************************************************************************/
void MAGA_GFX::setTextSize(uint8_t s) { setTextSize(s, s); }
...
*/
/**************************************************************************/
void MAGA_GFX::setTextSize(uint8_t s_x, uint8_t s_y) {
...
*/
/**************************************************************************/
void MAGA_GFX::setFont(const GFXfont *f) {
...
*/
/**************************************************************************/
void MAGA_GFX::charBounds(unsigned char c, int16_t *x, int16_t *y,
...
*/
/**************************************************************************/
void MAGA_GFX::getTextBounds(const char *str, int16_t x, int16_t y,
...
*/
/**************************************************************************/
void MAGA_GFX::getTextBounds(const String &str, int16_t x, int16_t y,
                                 int16_t *x1, int16_t *y1, uint16_t *w,
                                 uint16_t *h) {
  if (str.length() != 0) {
...
*/
/**************************************************************************/
void MAGA_GFX::getTextBounds(const __FlashStringHelper *str, int16_t x,
...
*/
/**************************************************************************/
void MAGA_GFX::invertDisplay(bool i) {
...
*/
/**************************************************************************/
MAGA_GFX_Button::MAGA_GFX_Button(void) { _gfx = 0; }
...
void MAGA_GFX_Button::initButton(MAGA_GFX *gfx, int16_t x, int16_t y,
...
*/
/**************************************************************************/
void MAGA_GFX_Button::initButtonUL(MAGA_GFX *gfx, int16_t x1,
...
*/
/**************************************************************************/
void MAGA_GFX_Button::drawButton(bool inverted) {
...
*/
/**************************************************************************/
bool MAGA_GFX_Button::contains(int16_t x, int16_t y) {
...
*/
/**************************************************************************/
bool MAGA_GFX_Button::justPressed() { return (currstate && !laststate); }
...
*/
/**************************************************************************/
bool MAGA_GFX_Button::justReleased() { return (!currstate && laststate); }
...
*/
/**************************************************************************/
GFXcanvas1::GFXcanvas1(uint16_t w, uint16_t h) : MAGA_GFX(w, h) {
...
*/
/**************************************************************************/
GFXcanvas16::GFXcanvas16(uint16_t w, uint16_t h) : MAGA_GFX(w, h) {
