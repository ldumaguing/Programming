...
frames: [4]c.SDL_FRect,

// ****************************************************************************
const DiSpriteAnimation = @This();

// ****************************************************************************
pub fn new(id: i32, sprite_sheet: *DiTexture, frames: [4]c.SDL_FRect) DiSpriteAnimation {
    return .{ .id = id, .sprite_sheet = sprite_sheet, .frames = frames };
}
