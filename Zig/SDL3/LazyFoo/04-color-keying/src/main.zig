...
pub var gFooTexture: LTexture = undefined;
pub var gBgTexture: LTexture = undefined;
...
pub fn main() !void {
    ...
    // ========================================================================
    gFooTexture = LTexture.new(1, "img/foo.png");
    gBgTexture = LTexture.new(2, "img/background.png");
    defer gFooTexture.destroy();
    defer gBgTexture.destroy();
    // ========================================================================
