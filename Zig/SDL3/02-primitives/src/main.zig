...
pub var points: [500]c.SDL_FPoint = undefined;
...
pub fn main() !void {
    ...
    const window: *c.SDL_Window, const renderer: *c.SDL_Renderer = create_window_and_renderer: {
        ...
        try errify(c.SDL_CreateWindowAndRenderer("02-primitives", window_w, window_h, 0, &window, &renderer));
    ...
    for (0..points.len) |i| {
        points[i].x = (c.SDL_randf() * 440.0) + 100.0;
        points[i].y = (c.SDL_randf() * 280.0) + 100.0;
    }
