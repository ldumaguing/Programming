...
var postcard_Up: DiTexture = undefined;
var postcard_Down: DiTexture = undefined;
var postcard_Left: DiTexture = undefined;
var postcard_Right: DiTexture = undefined;
pub var postcard_Curr: *DiTexture = undefined;
...
pub fn main() !void {
    ...
    // ========================================================================
    postcard_Up = DiTexture.new(0, "img/up.png");
    postcard_Down = DiTexture.new(1, "img/down.png");
    postcard_Left = DiTexture.new(2, "img/left.png");
    postcard_Right = DiTexture.new(3, "img/right.png");
    defer postcard_Up.destroy();
    defer postcard_Down.destroy();
    defer postcard_Left.destroy();
    defer postcard_Right.destroy();
    postcard_Curr = &postcard_Up;
    // ========================================================================
            ...
            switch (event.type) {
                ...
                c.SDL_EVENT_KEY_DOWN, c.SDL_EVENT_KEY_UP => {
                    switch (event.key.scancode) {
                        ...
                        c.SDL_SCANCODE_LEFT => {
                            print("left\n", .{});
                            postcard_Curr = &postcard_Left;
                        },
                        c.SDL_SCANCODE_RIGHT => {
                            print("right\n", .{});
                            postcard_Curr = &postcard_Right;
                        },
                        else => {},
                    }
                },
