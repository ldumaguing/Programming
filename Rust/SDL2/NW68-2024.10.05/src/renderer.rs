...
pub fn render(
    ...
    let fish = Rect::new(200, 200, SCREEN_WIDTH as u32, SCREEN_HEIGHT as u32);
    let _ = canvas.copy(&texture, fish, None);
    ...
    *counter += 5;
    ...
    let _ = canvas.line(0, 0, SCREEN_WIDTH as i16, SCREEN_HEIGHT as i16, color);
